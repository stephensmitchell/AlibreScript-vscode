...
class CircularArc3D:
    ...
    def __init__(self, center: List, start: List, end: List, is_reference: bool) -> None:
        """Creates a 3D arc using the center, start point and end point

        Args:
            center: Center point as [x, y, z]
            start: Start point as [x, y, z]
            end: End point as [x, y, z]
    ...
    def __init__(self, center: List, start: List, angle: float, is_reference: bool) -> None:
        """Creates a 3D arc using the center, start point and an angle
    ...
    Center: Any  # The center of the arc [x, y, z]
    EndPoint: Any  # The end point of the arc [x, y, z]
    IsReference: Any  # True if the arc is a reference arc, false if it is a regular arc
    Radius: Any  # Radius of arc
    StartPoint: Any  # The start point of the arc [x, y, z]
